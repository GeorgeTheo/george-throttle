$(function(){
    ...
    var form = $('#contact-form').find('form'),
        formElements = form.find('inpute!="submit"],textarea'),
    ...
    formSubmitButton.bind('click',function    var formok = true,
            errors = [];
    ...
    function showNotice(type,data)
    {
        if(type == 'error'){
            successNotice.hide();
            errorNotice.find("li'info']").remove();
            for(x in data){
